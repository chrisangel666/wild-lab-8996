...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/wild-lab-8996)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wild-lab-8996
```

A live public deployment of this template is available at [https://wild-lab-8996.templates.workers.dev](https://wild-lab-8996.templates.workers.dev)
